...
public class Rule01Test {
    ...
    com.ufla.lfapp.vo.grammar.Rule rule;
    // S -> aSBC

    @Before
    public void setUp() {
        rule = new com.ufla.lfapp.vo.grammar.Rule("S", "aSBC");
    }

    @Test
    public void testClone1() {
        com.ufla.lfapp.vo.grammar.Rule rc = (com.ufla.lfapp.vo.grammar.Rule) rule.clone();
