...
import com.ufla.lfapp.activities.automata.graph.views.edge.interactarea.BezierQuadraticCurve;
...
public class ArcEdgeDraw extends AbstractArcEdgeDraw {
    ...
    public Path getLabelPath() {
        ...
        if (isSameRow() && isOriginColumnLeft()) {
            labelPath.moveTo(pointControl.x - labelLenght / 2, pointControl.y
                    + displaceForEdgeText / 3);
            labelPath.lineTo(pointControl.x + labelLenght / 2, pointControl.y
                    + displaceForEdgeText / 3);
            ...
            labelPath.lineTo(pointControl.x + labelLenght, pointControl.y + displaceForEdgeText);
        } else {
            labelPath.moveTo(pointControl.x - labelLenght, pointControl.y + displaceForEdgeText);
