...
public class HistoricalAutomataActivity extends AppCompatActivityContext {


    private List<FiniteStateAutomatonGUI> automatonGUIs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (FiniteStateAutomatonGUI automatonGUI : automatonGUIs) {
...
//        });
    ...
    public FiniteStateAutomatonGUI getAutomatonWithId(long id) {
        for (FiniteStateAutomatonGUI automatonGUI : automatonGUIs) {
    ...
    private void update() {
        ...
        for (int i = 0; i < automatonGUIs.size(); i++) {
            ...
            if (newLabel != null && !newLabel.equals(automatonGUILabels.get(i))) {
