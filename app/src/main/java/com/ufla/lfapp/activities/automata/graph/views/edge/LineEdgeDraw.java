    ...
    public Path getLabelPath() {
        ...
        if (isSameRow()) {
            if (isOriginColumnLeft()) {
                labelPath.moveTo(circPoints.first.x, circPoints.first.y - displaceForEdgeText);
                labelPath.lineTo(circPoints.second.x, circPoints.first.y - displaceForEdgeText);
            } else {
                labelPath.moveTo(circPoints.second.x, circPoints.first.y - displaceForEdgeText);
                labelPath.lineTo(circPoints.first.x, circPoints.first.y - displaceForEdgeText);
            }
            ...
            labelPath.lineTo(middlePoint.x + labelLenght + displaceForEdgeText, middlePoint.y);
        } else {
            labelPath.moveTo(middlePoint.x - labelLenght - displaceForEdgeText, middlePoint.y);
