...
public class AcademicSupportFNG extends AcademicSupportRemoveLeftRecursiveAbstract {
    ...
    List<Set<Rule>> getNewRulesStage2() {
        return newRulesStage2;
    }

    List<Set<Rule>> getDeleteRulesStage2() {
        return deleteRulesStage2;
    }

    List<Set<Rule>> getNewRulesStage3() {
        return newRulesStage3;
    }

    List<Set<Rule>> getDeleteRulesStage3() {
    ...
    void addGrammarTransformationStage2(Set<Rule> ruleWithProblems, Set<Rule> newRules) {
        deleteRulesStage2.add(new LinkedHashSet<>(ruleWithProblems));
        newRulesStage2.add(new LinkedHashSet<>(newRules));
    }

    void addGrammarTransformationStage3(Set<Rule> ruleWithProblems, Set<Rule> newRules) {
